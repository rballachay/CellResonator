...
x=749;y= 407;w= 328;h= 129
# Initialize frame counter
cnt = 0
cap = cv2.VideoCapture('/Users/RileyBallachay/Downloads/July21_2021_Washing.mp4')
...
out = cv2.VideoWriter('result_total_july21.mp4', fourcc, fps, (w, h))
...
np.savetxt('sliced_july21.csv',sliced,delimiter=',')
