...
path = '/Users/RileyBallachay/Documents/Fifth Year/Work for Dr.Piret/Pipeline/Outlet/June 4/sliced.csv'
...
txt = '/Users/RileyBallachay/Documents/Fifth Year/Work for Dr.Piret/Resonator Data/June4.csv'
data = np.loadtxt(txt,delimiter=',', skiprows=1,usecols=(0,1))

ranger = list(range(22,45))
cellcount = np.loadtxt('June4.csv',delimiter=',', skiprows=0,usecols=(2,3),max_rows=21)
...
# make a plot
scaler = MinMaxScaler()
ax.plot(time[50:850]/60,scaler.fit_transform(scipy.ndimage.gaussian_filter1d(means[50:850],sigma=50).reshape(-1,1)),'maroon')
ax.plot(time[1000:1800]/60,scaler.fit_transform(scipy.ndimage.gaussian_filter1d(means[1000:1800],sigma=50).reshape(-1,1)),'maroon')
fig.autofmt_xdate()
# set x-axis label
