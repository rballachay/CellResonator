...
x=1040;y= 279;w= 241;h= 269
# Initialize frame counter
cnt = 0
cap = cv2.VideoCapture('/Users/RileyBallachay/Downloads/Aug30_2021_Concentration.mp4')
...
out = cv2.VideoWriter('result_total_aug30.mp4', fourcc, fps, (w, h))
...
np.savetxt('sliced_aug30_conc.csv',sliced,delimiter=',')
