...
x=1073;y=216;w= 238;h= 156


# Initialize frame counter
cnt = 0
cap = cv2.VideoCapture('/Users/RileyBallachay/Downloads/Sept17_2021_Concentration.mp4')
...
out = cv2.VideoWriter('result_total_sep17.mp4', fourcc, fps, (w, h))
...
np.savetxt('sliced_sep17_conc.csv',sliced,delimiter=',')
