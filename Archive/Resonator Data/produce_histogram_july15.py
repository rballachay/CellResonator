...
path = '/Users/RileyBallachay/Documents/Fifth Year/Work for Dr.Piret/Histogram_Slices/sliced_july15.csv'
sliced = np.loadtxt(path,delimiter=',')

means=sliced[:,:25].mean(axis=1)[::10]
...
txt = '/Users/RileyBallachay/Documents/Fifth Year/Work for Dr.Piret/Resonator Data/July15.csv'
...
# make a plot
scaler = MinMaxScaler()
ax.plot((time[100:850]-52)/60,scaler.fit_transform(scipy.ndimage.gaussian_filter1d(means[100:850],sigma=50).reshape(-1,1)),'maroon')
fig.autofmt_xdate()
# set x-axis label
