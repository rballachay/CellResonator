...
x = 319; y= 102; w=281; h= 500

# Open the video
cap = cv2.VideoCapture('Background/background_video.mp4')
...
cnt = 0
cap = cv2.VideoCapture('Original Videos/May10_2021.mp4')
...
out = cv2.VideoWriter('result_total_may10.mp4', fourcc, fps, (w, h))
...
print(sliced3[:10])
np.savetxt('sliced_v2.csv',sliced2,delimiter=',')
